                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group local-forms">
                                                <label for="customerName">Username <span
                                        ...
                                        <div class="col-12">
                                            <div class="form-group local-forms">
                                                ...
                                                <div id="customerEmailError" class="text-danger"></div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            <h5 class="form-title" style="margin-top: 25px;"><span>Update
                                                    Password</span></h5>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="password" class="form-control" id="customerPassword"
                                                    name="customer_password" autocomplete="off">
                                                <div id="customerPasswordError" class="text-danger"></div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group local-forms">
