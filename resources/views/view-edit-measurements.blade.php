                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">All Measurements</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active">View/Edit Measurements</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table
                                        ...
                                        <thead class="student-thread">
                                            <tr>
                                                ...
                                                <th class="text-center">لمبائی</th>
                                                <th class="text-center">تيرا</th>
                                                <th class="text-center">بازو</th>
                                                <th class="text-center">کندها</th>
                                                <th class="text-center">گلہ</th>
                                                <th class="text-center">چیسٹ</th>
                                                <th class="text-center">کمر</th>
                                                <th class="text-center">چیسٹ تیار</th>
                                                <th class="text-center">كمرتيار</th>
                                                <th class="text-center">گهیره تیار</th>
                                                <th class="text-center">شلوار لمبائی</th>
                                                <th class="text-center">پانچه</th>
                                                <th class="text-center">چکور گھیرا</th>
                                                <th class="text-center">گول گھیرا</th>
                                                <th class="text-center">بابا بازو</th>
                                                <th class="text-center">كف</th>
                                                <th class="text-center">لمبائی کوٹ</th>
                                                <th class="text-center">ہپ</th>
                                                <th class="text-end">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @forelse ($measurements as $index => $measurement)
                                            <tr>
                                                <td class="text-center">{{ $measurement->id }}</td>
                                                <!-- Check if the customer exists before accessing its properties -->
                                                <td class="text-center">
                                                    @if (isset($customers[$index]))
                                                    {{ $customers[$index]->customer_name }}</td>
                                                <td>{{ $customers[$index]->contact_number }}</td>
                                                @else
                                                <td colspan="2">No Name data</td>
                                                @endif
                                                </td>

                                                <td class="text-center">{{ $measurement->lambai }}</td>
                                                <td class="text-center">{{ $measurement->tera }}</td>
                                                <td class="text-center">{{ $measurement->bazu }}</td>
                                                <td class="text-center">{{ $measurement->kundah }}</td>
                                                <td class="text-center">{{ $measurement->galeh }}</td>
                                                <td class="text-center">{{ $measurement->chest }}</td>
                                                <td class="text-center">{{ $measurement->kamar }}</td>
                                                <td class="text-center">{{ $measurement->chest_tayyar }}</td>
                                                <td class="text-center">{{ $measurement->kamartiyaar }}</td>
                                                <td class="text-center">{{ $measurement->gohire_tayyar }}</td>
                                                <td class="text-center">{{ $measurement->shalwar_lambai }}</td>
                                                <td class="text-center">{{ $measurement->panche }}</td>
                                                <td class="text-center">{{ $measurement->chokor_ghera }}</td>
                                                <td class="text-center">{{ $measurement->gol_ghera }}</td>
                                                <td class="text-center">{{ $measurement->baba_bazu }}</td>
                                                <td class="text-center">{{ $measurement->kaff }}</td>
                                                <td class="text-center">{{ $measurement->lambai_kot }}</td>
                                                <td class="text-center">{{ $measurement->hip }}</td>
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('measurements.edit', ['id' => $measurement->id]) }}"
                                                        ...
                                                        <form
                                                            action="{{ route('measurements.destroy', ['measurement' => $measurement->id]) }}"
