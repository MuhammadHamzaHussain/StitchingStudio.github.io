                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">All Designation</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.html">Staff Management</a></li>
                                    <li class="breadcrumb-item active">View/Edit Designation</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $designation->designationName }}</td>
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('edit-designation', $designation->id) }}"
