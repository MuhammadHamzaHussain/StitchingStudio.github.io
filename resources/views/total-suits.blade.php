                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">All Suits</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active">All Suits</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    {{ \Carbon\Carbon::create()->month($order->month)->format('F') }}
                                                </td>
                                                <td class="text-center">{{ $order->year }}</td>
                                                <td class="text-end">{{ $order->total_suits }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
