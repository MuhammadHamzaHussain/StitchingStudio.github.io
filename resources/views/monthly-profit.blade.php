                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">Monthly Profit</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.html">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Monthly Profit</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center">
                                                    {{ \Carbon\Carbon::create()->month($profit->month)->format('F') }}
                                                </td>
                                                <td class="text-center">{{ $profit->year }}</td>
                                                <td class="text-end">{{ $profit->total_profit }}</td>
                                            </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
