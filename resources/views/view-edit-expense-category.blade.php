...
<head>
    ...
    <title>View Edit Expense Category</title>
    <!-- Fontfamily -->
    <link
...
<body>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                <h3 class="page-title">All Expense Category</h3>
                                <ul class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="students.html">Expense Management</a></li>
                                    <li class="breadcrumb-item active">View/Edit Expense Category</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table
                                        ...
                                        <thead class="student-thread">
                                            <tr>
                                                ...
                                                <th class="text-center">Expense Category Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="text-center">{{ $expenseCategory->id }}</td>
                                                <td class="text-center">{{ $expenseCategory->expenseCategoryName }}</td>
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('expense-category.edit', $expenseCategory->id) }}"
                                                            class="btn btn-sm bg-success-light me-2">
                                                            <i class="fas fa-edit"></i>
                                                        </a>

                                                        <form
                                                            action="{{ route('expense-category.destroy', $expenseCategory->id) }}"
    ...
    $(document).ready(function() {
        $('.delete-form').on('submit', function(e) {
            ...
            $('#yesButton').one('click',
                function() { // Use one() to ensure the event handler is only triggered once
                    $.ajax({
