...
<body>
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                        ...
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">View/Edit Staff</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="student-group-form">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="form-group">
                                <input type="text" id="searchByContact" class="form-control" placeholder="Search by Contact Number ...">
                            </div>
                        </div>
                        <div class="col-lg-3">
                                    ...
                                    <table class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('staff.edit', $staff->id) }}" class="btn btn-sm bg-success-light me-2">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('staff.destroy', $staff->id) }}" method="POST" class="d-inline delete-form">
                                                            @csrf
                                                            @method('DELETE')
            ...
            <div id="alertModal" class="centered-modal">
                ...
                <div class="d-flex justify-content-center">
                    <button id="yesButton" class="btn btn-success" style="background-color: #FF0000; color: white; border: 1px solid #FF0000;">Yes</button>
            ...
            $('#yesButton').click(function() {
                $.ajax({
                    ...
                    success: function(response) {
                        $('#alertModal').fadeOut(); // Fade out the modal on successful data submission
    ...
    function performSearch() {
        ...
        const searchByContact = document.getElementById('searchByContact').value.toLowerCase();
        // Get the table rows
        ...
        rows.forEach(row => {
            ...
            const contactCell = row.querySelector('td:nth-child(6)').textContent.toLowerCase();
            // Check if the row matches the search criteria
            const matchesId = !searchById || idCell.includes(searchById);
            const matchesName = !searchByName || nameCell.includes(searchByName);
            const matchesContact = !searchByContact || contactCell.includes(searchByContact);
            // Show or hide the row based on the search criteria
            if (matchesId && matchesName && matchesContact) {
                row.style.display = '';
            } else {
