...
<body>
            ...
            <div class="content container-fluid">
                        ...
                        <div class="col-sm-12">
                            <div class="page-sub-header">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">View/Edit Expense</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="student-group-form">
                    <div class="row">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                <input type="text" id="searchByCategory" class="form-control"
            ...
            $('#yesButton').off('click').on('click', function() {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $(form).closest('tr')
                            .remove(); // Remove the deleted row from the table
                    },
                    error: function(xhr) {
    ...
    function performSearch() {
        ...
        const searchByCategory = document.getElementById('searchByCategory').value.toLowerCase();
        ...
        rows.forEach(row => {
            ...
            const matchesCategory = categoryCell.includes(searchByCategory);
